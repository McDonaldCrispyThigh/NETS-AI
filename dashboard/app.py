...
def main():
    ...
    st.markdown("""
    Enhanced NETS database with statistical employee estimation and business survival detection.
    Data for Quick Service Restaurants (NAICS 722513) and Pharmacies (NAICS 446110).
    """)
    
    # Load data
    parquet_path = "data/processed/nets_enhanced_minneapolis.parquet"
